...
fs.readFile('price.json', (err, data) => {
  ...
  console.log('Поддержка:', supportResistanceLevels.monthSupport) ;
  console.log('Сопротивление:', supportResistanceLevels.monthResistance) ;
  console.log('Текущий день:');
  console.log('Поддержка:', supportResistanceLevels.daySupport);
  console.log('Сопротивление:', supportResistanceLevels.dayResistance);
  console.log('Текущий период:');
  console.log('Поддержка:', supportResistanceLevels.currentSupport) ;
  console.log('Сопротивление:', supportResistanceLevels.currentResistance);
