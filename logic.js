...
console.log(`ОТ х 30.0 х ДО х 70.0 х
Текущая: х ${rsi1h} х
 ${oversold1h ? 'Перепродано 😬 ПОКУПАЙ!' : overbought1h ? 'Перекупленно 😬 ПРОДАВАЙ!' : overdohuyasold1h ? 'Ахуеть как Перепродано 😵 ПОКУПАЙ АКТИВНЕЕ!' : overbought1h ? 'Ахуеть как Перекупленно 😵 ПРОДАВАЙ АКТИВНЕЕ!' : 'Жди🚬'}`);
